...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Sistema de gestão de escalas extras" },
      { name: "author", content: "Grupo Juliani" },
      { name: "google", content: "notranslate" },
      { property: "og:title", content: "Escalas Extras" },
      { property: "og:description", content: "Sistema de gestão de escalas extras" },
